...
|Rolling out starting March 1, 2021 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|**GCC-High and DoD only**<br> Microsoft Teams cloud meeting recordings can now be enabled for your organization. Users will be able to record Teams meetings and have them stored in OneDrive and SharePoint  by default (using Stream is not an option).<br> <br>[Learn how to turn on this new feature](https://docs.microsoft.com/en-us/microsoftteams/cloud-recording#turn-on-or-turn-off-cloud-recording) in the Microsoft Teams admin center or PowerShell.|
